...
Vendored from [`nowork-studio/toprank`](https://github.com/nowork-studio/toprank) for installation through the `motlin-claude-code-plugins` marketplace.
...
```
/plugin install toprank@motlin-claude-code-plugins
```
...
```json
{
  ...
  "enabledPlugins": {
    "toprank@motlin-claude-code-plugins": true
  }
}
```
