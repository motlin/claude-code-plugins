...
**Step 4: Simplify** — Runs the `/simplify` command, which reviews the diff for code reuse opportunities, quality issues, and efficiency problems. Three review agents run in parallel (reuse, quality, efficiency) and their findings are fixed.
...
- **[code](../code/README.md)** — `/simplify` command
