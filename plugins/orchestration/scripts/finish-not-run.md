...
It handles building, committing, simplifying, and rebasing — the full completion pipeline. Do not attempt individual steps yourself. Do not run pipeline steps inline. The finish skill exists so nothing gets missed.
