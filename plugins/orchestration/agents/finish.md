...
- Spawn a `git:commit-handler` subagent. Pass the caller's prompt as the commit intent. The agent distills it into a single-line commit message; it does not copy the prompt verbatim.
